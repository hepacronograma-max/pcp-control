/**
 * Aplica supabase/migrations/20260824_packaging_volumes.sql no projeto remoto.
 * Uso: node scripts/apply-packaging-volumes-migration.js
 */
const fs = require("fs");
...
const sqlPath = path.join(
  ...
  "supabase",
  "migrations",
  "20260824_packaging_volumes.sql"
);
...
async function main() {
  ...
  console.log("Aplicando migration packaging_volumes...");
