...
import { PackagingBoxesAdmin } from "@/components/configuracoes/packaging-boxes-admin";
    ...
    <div className="space-y-4 max-w-5xl">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Catálogo usado na etiqueta de embalagem (código, medidas e peso
          vazio). O saldo controlado na linha é o das peças do item, não o
          de caixas no almoxarifado.
        </p>
      </div>
      <PackagingBoxesAdmin companyId={effectiveCompanyId} />
    </div>
  );
}
